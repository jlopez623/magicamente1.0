...
function listaParticion(a, b) {
    ...
    if (b <= 80) {
        for (let e of lista) {
            ...
            label.innerText = e;
            p = document.getElementById;('content1')
...
function grafGen() {
    ...
    function obtenerValores() {
        ...
        var espiritual = listapruebas[3] + listapruebas[16] + listapruebas[29] + listapruebas[32] + listapruebas[38] + listapruebas[48] + listapruebas[55] + listapruebas[59];
        dataUser.push(espiritual);

        //suma3+6+9+14+16+29+32+48
        var fisica = listapruebas[2] + listapruebas[5] + listapruebas[8] + listapruebas[13] + listapruebas[15] + listapruebas[28] + listapruebas[31] + listapruebas[47];
        dataUser.push(fisica);

        //suma 2+5+19+21+25+35+37+40
        var mental = listapruebas[1] + listapruebas[4] + listapruebas[18] + listapruebas[20] + listapruebas[24] + listapruebas[34] + listapruebas[36] + listapruebas[39];
        dataUser.push(mental);

        //suma: 23+41+43+50+59+61+65+67
        var emocional = listapruebas[22] + listapruebas[40] + listapruebas[42] + listapruebas[49] + listapruebas[58] + listapruebas[60] + listapruebas[64] + listapruebas[66];
        dataUser.push(emocional);

        //suma: 1+11+47+52+55+58+62+68
        var ludica = listapruebas[0] + listapruebas[10] + listapruebas[46] + listapruebas[51] + listapruebas[54] + listapruebas[57] + listapruebas[61] + listapruebas[67];
        dataUser.push(ludica);

        //suma 12+18+22+53+63+64+69+70
        var familiar = listapruebas[11] + listapruebas[17] + listapruebas[21] + listapruebas[52] + listapruebas[62] + listapruebas[63] + listapruebas[68] + listapruebas[69];
        dataUser.push(familiar);

        //suma 10+13+42+45+54+57+73+75
        var social = listapruebas[9] + listapruebas[12] + listapruebas[41] + listapruebas[44] + listapruebas[53] + listapruebas[59] + listapruebas[72] + listapruebas[74];
        dataUser.push(social);

        //suma 7+8+15+24+26+36+38+44
        var economica = listapruebas[6] + listapruebas[7] + listapruebas[14] + listapruebas[23] + listapruebas[25] + listapruebas[35] + listapruebas[37] + listapruebas[43];
        dataUser.push(economica);

        //suma 31+34+74++76+77+78+79+80
        var ecologica = listapruebas[30] + listapruebas[33] + listapruebas[73] + listapruebas[75] + listapruebas[76] + listapruebas[77] + listapruebas[78] + listapruebas[79];
        dataUser.push(ecologica);

        //suma 20+27+28+46+51+66+71+72
        var laboral = listapruebas[19] + listapruebas[26] + listapruebas[27] + listapruebas[45] + listapruebas[50] + listapruebas[65] + listapruebas[70] + listapruebas[71];
    ...
    var marksData = {
        labels: ["Espritual", "Física", "Mental", "Emocional", "Lúdica", "Familiar", "Social", "Económica", "Ecológica", "Laboral"],
        datasets: [{
            label: "Tu resultado",
